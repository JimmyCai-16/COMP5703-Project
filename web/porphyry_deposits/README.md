...
- After running python manage.py migrate as required, a data table named ‘porphyry_deposits_predictiondata’ will appear in the database, select it and run the SQL command 
   COPY porphyry_deposits_predictiondata(x, y, "SAMPLE_1", "SAMPLE_2", predicted_probabilities)
